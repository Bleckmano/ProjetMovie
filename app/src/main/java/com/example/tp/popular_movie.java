...
public class popular_movie extends AppCompatActivity implements PopularMovieAdapter.OnMovieListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId()==R.id.fr){
            ...
            if(app.getActiveFragment()=="UPCOMING")
                call=movieService.getUpcomingMovies("e055eb06ec8c66402ec80ac9243cd518",1,"fr");
            if(app.getActiveFragment()=="POPULAR")
                call=movieService.getPopularMovies("e055eb06ec8c66402ec80ac9243cd518",1,"fr");
        ...
        if (item.getItemId()==R.id.eng){
            ...
            if(app.getActiveFragment()=="UPCOMING")
                call=movieService.getUpcomingMovies("e055eb06ec8c66402ec80ac9243cd518",1,"eng");
            if(app.getActiveFragment()=="POPULAR")
                call=movieService.getPopularMovies("e055eb06ec8c66402ec80ac9243cd518",1,"eng");
            mRecyclerView=findViewById(R.id.rvPopularMovies);
            mRecyclerView.setLayoutManager(new GridLayoutManager(context,2));
            call.enqueue(new Callback<PopularMovieResponse>() {
                @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MovieService movieService=new Retrofit.Builder()
                ...
                .create(MovieService.class);
        app.setActiveLanguage("FR");
        Call<PopularMovieResponse> call=movieService.getPopularMovies("e055eb06ec8c66402ec80ac9243cd518",1,"fr");
        mRecyclerView=findViewById(R.id.rvPopularMovies);
        mRecyclerView.setLayoutManager(new GridLayoutManager(context,2));
